...
/*   Updated: 2013/11/27 14:38:06 by rgary            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "libft.h"

static char *ft_fill_right(const char *s, char *str, char c, size_t total)
{
	int		i;
...
static char	*ft_fill_left(const char *s, char *str, char c, size_t fill)
{
	int		i;
	int		j;
